...
// Inicializar un array para almacenar los títulos y nombres de usuario
$resultados = array();

// Iterar sobre cada elemento en el array "response2_decoded"
foreach ($response2_decoded['data'] as $item) {
    // Obtener el título y el nombre de usuario de cada elemento
    $titulo = $item['title'];
    $nombreUsuario = $item['user_name'];
    
    // Almacenar los resultados en un nuevo array con el formato deseado
    $resultados[] = array(
...
// Formar un nuevo array con el formato deseado

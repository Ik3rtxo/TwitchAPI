...
if (isset($_GET['opcion'])){
	...
	if (strcmp($opcion, "streams_vivo") == 0){
		$url = "https://api.twitch.tv/helix/streams";
	}else if (strcmp($opcion, "top_juegos") == 0){
		$url = "https://api.twitch.tv/helix/games/top";
	}else if (strcmp($opcion, "informacion_video") == 0){
		$url = "https://api.twitch.tv/helix/videos?id=" . urlencode($id);
	}else if (strcmp($opcion, "informacion_usuario") == 0){
		$url = "https://api.twitch.tv/helix/users?login=" . urlencode($id);
	}else if (strcmp($opcion, "informacion_etiquetas") == 0){
